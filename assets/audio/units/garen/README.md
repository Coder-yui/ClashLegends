...
| 形态/阵营 | 配置的事件与声音池 |
| --- | --- |
| 基础 | `death`、`empowered_buff:end`、`empowered_buff:start`、`empowered_ready`、`empowered_swing`、`judgment:end`、`judgment:hit`、`judgment:start`、`judgment:sustain`、`attack_swing`、`attack_hit` |
