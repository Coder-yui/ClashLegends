...
static func definition() -> Dictionary:
	return {
		"gameplay": {
			...
			"speed": SPEED_SLIGHTLY_FAST, "interval": 1.1, "first_hit": 0.35,
		...
		"visual": {"visual_scene_path": "res://assets/units/kayn/kayn_view.tscn", "visual_forward_yaw": 0.0,
			"visual_animations": {"deploy": "Idle1_Base", "idle": "Idle1_Base", "move": "Run", "attack": ["Attack1", "Attack2", "Attack3"], "death": "Death", "death_duration": 1.0,
				"visual_actions": {"active": {"animation": ["Spell1_Dash", "Spell1_Circle", "Spell1_Stop"], "durations": [0.3, 0.2, 0.2], "kind": "skill"}}},
