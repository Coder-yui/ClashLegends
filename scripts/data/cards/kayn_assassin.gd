...
static func definition() -> Dictionary:
	...
	data.gameplay.merge({"selectable": false, "name": "影流之镰·蓝凯", "hp": 650, "damage": 110, "speed": SPEED_EXTREMELY_FAST, "interval": 0.85, "first_hit": 0.25, "terrain_entry_heal": 120, "terrain_entry_speed_multiplier": 1.3, "description": "蓝凯：高速高伤，进入地形回复120生命并加速30%持续1秒。巨镰横扫仅需1金币。"}, true)
	...
	data.visual.visual_animations.deploy = "Kayn_Idle1_Assassin_anm"
