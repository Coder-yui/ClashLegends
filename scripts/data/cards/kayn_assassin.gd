...
static func definition() -> Dictionary:
	...
	data.audio = {
		"events": {
				"deploy:voice": {"pool": ["res://assets/audio/units/kayn/kayn_assassin_deploy_voice_1.wav", "res://assets/audio/units/kayn/kayn_assassin_deploy_voice_2.wav", "res://assets/audio/units/kayn/kayn_assassin_deploy_voice_3.wav"], "volume_db": 3.0, "bus": "Voice"},
			"active:cast": {
				"pool": [
			...
			"terrain:sustain": {"pool": ["res://assets/audio/units/kayn/kayn_assassin_terrain_sustain.wav"], "volume_db": 2.0, "bus": "Combat"},
				"terrain:exit": {"pool": ["res://assets/audio/units/kayn/kayn_assassin_terrain_exit.wav"], "volume_db": 2.0, "bus": "Combat"},
				"terrain:enter": {
				"pool": [
