...
const TEXT_FIELDS := ["attack_wave_visual", "heal_on_hit_name", "on_hit_passive_name", "growth_ranged_id", "growth_melee_id", "deployment_upgrade_id", "icon_path", "rush_spawn_id", "name", "type", "description", "size_tier", "deploy_zone", "spawn_id", "spawn_side", "death_spawn_id", "death_replacement_id", "death_replacement_visual_transition", "timed_revival_id", "timed_revival_visual_transition", "active_buff_projectile_visual", "projectile_visual", "projectile_impact_visual", "deploy_sweep_name", "spell_kind", "active_name", "visual_active_buff_scene", "visual_scene_path", "kind", "visual_action", "shape", "full_resource_visual_action", "target_scope", "deployment_formation"]
