...
## 用法：
##   Godot --path . --script tools/capture_promo_videos.gd --write-movie /tmp/shot.avi --fixed-fps 30 --resolution 1280x720 --quit-after 360 -- --shot=tower
##   Godot --path . --script tools/capture_promo_videos.gd --write-movie /tmp/shot.avi --fixed-fps 30 --resolution 1280x720 --quit-after 360 -- --shot=crystal
