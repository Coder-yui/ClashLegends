...
普通攻击分别有挥翼、冰锥发射与实际命中声音。风暴的持续声跟着地面区域走，冰鸟死亡不会提前停掉已落地的风暴；区域结束时播放消散声。复活过程由蛋的音频页说明。

## 声音与试听

| 发生时机 | 已接变体 | 音量调整 | 试听示例 |
| --- | --- | --- | --- |
| 普通攻击出手 | 1 | -3 dB | [试听 1](../../../assets/audio/units/anivia/play_sfx_anivia_aniviabasicattack_oncast_d.wav) |
