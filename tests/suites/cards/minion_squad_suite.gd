...
func run(harness: Object, main: Node2D) -> void:
	...
	var exhausted: bool = activated and int(main._active_skills[ability_id].uses_remaining) == 0 and float(main._active_skills[ability_id].cooldown_left) == 6.0 and not main._activate_active_skill(ability_id, 0)
